  ...
  >
    ...
    >
      ...
      <div>
        ...
        <p className="text-sm md:text-lg font-bold leading-tight tabular-nums">
          {sriLankaTime}
        </p>
        <p className="hidden sm:block mt-0.5 text-[10px] text-white/65">
          {sriLankaDate}
        </p>
      </div>
    </div>
    ...
    <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center justify-center px-5 md:px-10 py-32 text-center text-white">
      ...
      {/* Mobile Description */}
      <p
        className="animate-fade-up mt-6 max-w-3xl text-base md:text-lg leading-relaxed text-white/85 sm:hidden"
      ...
      {/* Desktop Description */}
      <div
        className="animate-fade-up mt-6 hidden max-w-4xl text-base md:text-lg leading-relaxed text-white/85 sm:block"
        style={{ animationDelay: "240ms" }}
      >
        <span className="block">
          Ancient citadels, misty tea hills, wild elephants and empty beaches —
        </span>
        <span className="block">
          Serendib Trails builds private, expert-guided itineraries
        </span>
        <span className="block">
          across Sri Lanka, from your first enquiry to the moment
        </span>
        <span className="block">
          you land back home.
        </span>
      ...
      {/* Stats */}
      <dl
        className="animate-fade-up mt-14 grid w-full max-w-md grid-cols-3 gap-6 border-t border-white/15 pt-6 text-center"
